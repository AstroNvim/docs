...
- `astronvim.default_tbl(override_tbl, default_tbl)` internal function has been removed and replaced with `astronvim.extend_tbl(default_tbl, override_tbl)`. If you use the original function anywhere in your config, remember to rename it and change the order of the parameters.
