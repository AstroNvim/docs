...
Please follow the [Installation Guide](/v4/#-installation). Make sure that your system meets all of the listed [Requirements](/v4/#-requirements). Please be aware that some features, like folding, might be missing if you're not using the latest stable release of Neovim and/or AstroNvim. There's also no support for nightly Neovim so make sure to be running a stable version if you're experiencing issues.
...
Make sure you have [ripgrep](https://github.com/BurntSushi/ripgrep) installed. For other missing feature please check [optional requirements section](/v4/#-requirements) in the documentation.
