...
banner:
  content: |
    AstroNvim v6 is officially released! Upgrade today with the <a href="/configuration/v6_migration/">v6 migration guide</a>!
---
...
- Package management with [mason.nvim](https://github.com/mason-org/mason.nvim)
