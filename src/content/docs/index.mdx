...
Be sure to check out the [Configuration/Custom Plugins](/configuration/custom_plugins) page and the [Lazy.nvim Documentation](https://github.com/folke/lazy.nvim?tab=readme-ov-file#-plugin-spec) for more details in how to define and configure plugins using `lazy.nvim`.
