...
banner:
  content: |
    AstroNvim v5 is officially released! Upgrade today with the <a href="/v5/configuration/v5_migration/">v5 migration guide</a>!
---
...
[Frequently Asked Questions](/v5/faq)!
...
- [Nerd Fonts](https://www.nerdfonts.com/font-downloads) (_Optional with manual intervention:_ See [Recipes/Customizing Icons](/v5/recipes/icons#disable-icons)) <sup>[[1]](#1)</sup>
...
<sup id="2">\[2\]</sup> When using default theme: The default MacOS terminal
does not support true colors until Tahoe 26. On older versions, use
...
or another [terminal emulator](https://github.com/termstandard/colors) that has
true color support.
...
Be sure to check out the [Configuration/Customizing Plugins page](/v5/configuration/customizing_plugins) and the [Lazy.nvim Documentation](https://lazy.folke.io/spec) for more details in how to define and configure plugins using `lazy.nvim`.
