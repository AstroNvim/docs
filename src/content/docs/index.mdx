...
banner:
  content: |
    AstroNvim v4 is right around the corner and is curently in a public beta! Try it today by checking out the <a href="https://deploy-preview-120--peaceful-platypus-6db452.netlify.app/">v4 documentation</a> and the <a href="https://discord.gg/XuXj6kHF">#v4-testing channel</a> on the AstroNvim Discord!
---
...
<sup id="1">[1]</sup> All downloadable Nerd Fonts contain icons which are used by
AstroNvim. Install the Nerd Font of your choice to your system and in your terminal
...
<sup id="2">[2]</sup> When using default theme: For MacOS, the default terminal does
not have true color support. You will need to use <a href="https://iterm2.com/">
  iTerm2
</a>
, <a href="https://sw.kovidgoyal.net/kitty/">Kitty</a>, <a href="https://wezfurlong.org/wezterm/">
  WezTerm
</a>, or another <a href="https://github.com/termstandard/colors">
  terminal emulator
</a> that has true color support.
