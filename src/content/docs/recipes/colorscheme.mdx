...
1. Add the colorscheme plugin
   ...
   You can either add a colorscheme plugin directly to your `plugins` as described in the [Customizing Plugins Page](/v4/configuration/customizing_plugins), for example if you wanted to add [Catppuccin](https://github.com/catppuccin/nvim) you would add the following to your `plugins`:
