...
4. Once you have your configuration set up how you like it, move it over to the default neovim configuration location `~/.config/nvim`:
   ...
   mv ~/.local/share/astronvim_v4 ~/.local/share/nvim # move new data folder
   mv ~/.local/state/astronvim_v4 ~/.local/state/nvim # move new state folder
   mv ~/.cache/astronvim_v4 ~/.cache/nvim # move new cache folder
