...
<TabItem value="fresh" label="Fresh Installation" icon="seti:shell" default>
...
<TabItem value="getting_started" label="Followed Getting Started" icon="rocket">

<Steps>

1. Follow the [Getting Started Guide Installation](/#-installation)
