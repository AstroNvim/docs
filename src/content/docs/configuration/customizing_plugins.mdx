...
A lot of these configuration functions share common themes and has allowed us to build and provide a few useful utility functions in [AstroCore](/v4/configuration/core_plugins/#astrocore).
